...
public class Cliente {
    ...
    public void unirseAlJuego() {
        try {
            server.unirseAlJuego(); // Llama al método remoto del servidor para jugar una carta
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) {
        ...
        // Aquí puedes llamar a los métodos del cliente para interactuar con el servidor
